...
class CarController extends Controller
{
    ...
    public function edit($id)
    {
        $car = DB::table('cars')
            ...
            ->leftJoin('car_images', 'car_images.car_id', '=', $id) // Join cars with car_images
            ->select('cars.id', 'cars.type', 'cars.car_model', 'cars.color', 'cars.price', 'cars.status', DB::raw('GROUP_CONCAT(car_images.image) as images')) // Select fields
            ->groupBy('cars.id', 'cars.type', 'cars.car_model', 'cars.color', 'cars.price', 'cars.status') // Group by all selected car fields
