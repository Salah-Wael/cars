...
class CarController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        ->join('car_images', 'cars.id', '=', 'car_images.car_id') // Join cars with car_images table
        ->select('cars.*', 'car_images.image') // Select cars columns and the related image column
