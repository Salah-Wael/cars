...
class CarController extends Controller
{
    ...
    {
        $cars = Car::orderby('created_at', 'desc')->paginate(21);
    ...
    public function edit($id)
    {
        $car = Car::find($id);
        if ($car) {
            return view('car.edit', compact('product'));
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($car) {
            ...
            if ($request->hasFile('image')) {
                ImageController::deleteImage($request->image, 'assets/img/products/');
                $car->image = ImageController::storeImage($request, 'image_path', 'assets/img/products/');
            }
            ...
            return redirect()->route('car.index')->with(['message' => 'Product updated successfully']);
        }
    }
