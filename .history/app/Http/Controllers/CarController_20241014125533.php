...
class CarController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        ->select('cars.*', DB::raw('GROUP_CONCAT(car_images.image) as images')) // Concatenate all images into one field
        ->groupBy('cars.id') // Group by car to avoid duplicate car data
