...
class CarController extends Controller
{
    ...
    public function edit($id)
    {
        $car = DB::table('cars')
            ...
            ->select('cars.id', 'cars.type', 'cars.car)model', 'cars.color', 'cars.price', 'cars.status', DB::raw('GROUP_CONCAT(car_images.image) as images')) // Select fields
            ->groupBy('cars.id', 'cars.type', 'cars.model', 'cars.color', 'cars.price', 'cars.status') // Group by all selected car fields
