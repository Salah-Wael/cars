...
class CarController extends Controller
{
    ...
    {
        Car::find($id)->delete();
        return redirect()->route('car.index')->with(['message' => 'Car post deleted successfully']);
    }
    ...
    public function forceDelete($id)
    {
        ...
        if ($car) {
            ImageController::deleteImage($car->image_path, 'assets/img/products/');
            $car->delete();
            return redirect()->route('car.index')->with(['message' => 'Product deleted successfully']);
        }
    ...
    {
        $car = Car::onlyTrashed()->find($id)->restore();
        return redirect()->back()->with(['message' => 'Car post restored successfully']);
    }
