...
class CarController extends Controller
{
    ...
    public function carsRequests()
    {
        ...
        ->select('cars.*', DB::raw('GROUP_CONCAT(car_images.image) as images'))
        ->groupBy('cars.id', 'cars.type', 'cars.image', 'cars.car_model', 'cars.color', 'cars.plate', 'cars.status', 'cars.price', 'cars.description')
        ->get();
