    ...
    public function store(Request $request)
    {
        $request->validate(
            ...
            [
        		...
        		color	plate	image	description	price	status	user_id	created_at	updated_at

        $car = new Car();
        $car->name = $request->name;
        $car->description = $request->description;
        $car->model = $request->model;
        $car->color = $request->model;
        $car->price = $request->price;
        $car->image = ImageController::storeImage($request, 'image', 'assets/img/products/');
        $car->save();
