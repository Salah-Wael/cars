...
class CarController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate(
        	...
        	model	color	plate	image	description	price	status	user_id	created_at	updated_at
        ...
        $car->image_path = ImageController::storeImage($request, 'image_path', 'assets/img/products/');
        $car->save();
        return redirect()->route('car.index')->with(['message' => 'Product added successfully']);
    }
