...
class CarController extends Controller
{
    ...
    {
        $cars = DB::table('cars')
    ->leftJoin('car_images as images1', 'cars.id', '=', 'images1.car_id')
    ->where('cars.post_status', '=', 0)
    ->select('cars.id', 'cars.type', 'cars.car_model', 'cars.color', 'cars.plate', 'cars.status', 'cars.price', 'cars.description', DB::raw('GROUP_CONCAT(images1.image) as images'))
