...
class CarController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        ->where('cars.id', $id) // Filter by car ID
            ...
            ->select('cars.id', 'cars.type', 'cars.car_model', 'cars.plate', 'cars.color', 'cars.price', 'cars.status', DB::raw('GROUP_CONCAT(car_images.image) as images')) // Select fields
            ->groupBy('cars.id', 'cars.type', 'cars.car_model', 'cars.plate', 'cardescription','cars.color', 'cars.price', 'cars.status') // Group by all selected car fields
