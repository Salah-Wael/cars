...
Route::controller(CarImagesController::class)->prefix('/car')->name('car.')->group(function () {
    Route::get('/{carId}/images', 'showCarImages')->name('show.images');
    Route::post('/{carId}/store/images', 'storeImages')->name('store.images');
    Route::delete('/image/{imageId}/delete', 'deleteImage')->name('delete.image');
});
