...
Route::controller(CarController::class)->group(function () {
    ...
    Route::get('/cars/requests', '    public function carsRequests()
')->name('car.table')->middleware('checkrole:admin');
    ...
    Route::get('/car/{id}/delete', 'forceDelete')->name('car.force-delete')->middleware('checkrole:admin,user');
