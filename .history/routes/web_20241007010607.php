...
Route::controller(CarImagesController::class)->prefix('')->name('car.')->group(function () {
    Route::get('/car/{carId}/images', 'showProductImages')->name('show.images')->middleware('auth');
    Route::post('/car/{carId}/store/images', 'storeImages')->name('store.images')->middleware('checkrole:admin');
    Route::delete('/car/image/{imageId}/delete', 'deleteImage')->name('delete.image')->middleware('checkrole:admin');
});
