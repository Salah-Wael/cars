...
Route::controller(CarController::class)->group(function () {
    ...
    Route::get('/car/{id}/archived', 'softDelete')->name('car.soft-delete')->middleware('checkrole:admin');
    Route::get('/car/{id}/force-delete', 'forceDelete')->name('car.soft-delete')->middleware('checkrole:admin');
    Route::get('/car/restore/{id}', 'restore')->name('car.restore');
    Route::get('/cars/archived', 'getAllArchivedCars')->name('car.archived');
});
