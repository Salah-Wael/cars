                            ...
                            @if (count($relatedNews) > 0)
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <!-- Link starts here for the whole row -->
                                            <td >
                                                <a href="{{ route('news.show', $relatedNew->id) }}" class="plain-link" style="display: block; text-decoration: none; color: inherit;">

                                                    <!-- Image column -->
                                                    <td style="width: 100px;">
                                                        <img src="{{ asset('assets/img/news/' . $relatedNew->image) }}"
                                                            alt="{{ $relatedNew->title }}" style="width: 100px; height: auto;">
                                                    </td>
