                ...
                @foreach ($relatedNews as $relatedNew)
                    <tr>
                        ...
                        <td style="width: 100px;">
                            @if (!empty($relatedNew->image))
                                <img src="{{ asset('assets/img/news/'.$relatedNew->image) }}" alt="{{ $relatedNew->title }}" style="width: 100px; height: auto;">
                            @else
                                <img src="{{ asset('assets/img/default-image.jpg') }}" alt="Default image" style="width: 100px; height: auto;">
                            @endif
                        </td>
