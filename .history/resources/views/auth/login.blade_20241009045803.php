...
@section('content')
    <div class="w-[400px] flex flex-col items-center justify-center p-8 bg-neutral-50">
    	    ...
    	    <form method="POST" action="{{ route('login') }}" class="w-full">
                ...
                <br><br>
                <button class="w-full py-3 bg-red-500 text-white no-underline rounded-md font-semibold text-base mt-4">
                    <a href="{{ route('dashboard') }}" class="w-full py-3 bg-red-500 text-white rounded-md font-semibold no-underline text-base mt-4">
                    Login as a guest
                </a>
                </button>
