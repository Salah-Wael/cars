...
@section('content')
    <div class=" flex flex-col items-center justify-center p-8 bg-neutral-50">
        ...
        <form method="POST" action="{{ route('login') }}" class="w-full">
            ...
            <div class="mb-6">
                ...
                <input class="w-full px-3 py-2 rounded-md bg-neutral-300" id="email" type="email" name="email"
            ...
            <div class="mb-6">
                ...
                <input class="w-full px-3 py-2 rounded-md bg-neutral-300" id="password" type="password" name="password"
            ...
            <button class="w-full py-3 bg-red-500 text-white rounded-md font-semibold text-base mt-4">
                <a href="{{ route('dashboard') }}"
                    class="w-full py-3 bg-red-500 text-white rounded-md font-semibold text-base mt-4">
                    Login as a guest
                </a>
            </button>
