...
<html lang="en">
  ...
  <body>
    <div id="full">
      <div class="w-[800px] min-h-[1000px] flex bg-neutral-50 rounded-lg shadow-lg">
        {{-- <div class="w-[400px] bg-neutral-300 flex items-center justify-center">
            <img src="{{asset('assets/img/app/1.jpeg')}}" alt="" >
        </div> --}}
        <div style="height: 700px; padding-top:90px;" class="w-full h-full flex items-center justify-center">
