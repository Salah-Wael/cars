    ...
    <div id="full">
      <div class="w-[800px] min-h-[600px] flex bg-neutral-50 rounded-lg shadow-lg">
        <div class="w-[400px] bg-neutral-300 flex items-center justify-center">
            ...
            <source src="audio and video/download.mp4" type="video/mp4">
            <source src="audio and video/download.ogg" type="video/ogg">
            <source src="audio and video/download.webm"type="video/webm">
