            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                <div class="mx-auto">
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        ...
                        <!-- Car Manufacturers (with sub-menu) -->
                        <li class="nav-item dropdown">
                            <a class="nav-link fw-semibold fs-6 ms-2" href="{{ route('car_manufacturers.index') }}">Manufacturers</a> <!-- Direct link -->

                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                @if (auth()->check() && auth()->user()->role == 'admin')
                                    <li><a class="dropdown-item" href="{{ route('car_manufacturers.create') }}">Add Manufacturer</a></li>
                                    <li><a class="dropdown-item" href="{{ route('car_manufacturers.table') }}">Manufacturers Requests</a></li>
                                    <li><a class="dropdown-item" href="{{ route('car_manufacturers.archived') }}">Archived Manufacturers</a></li>
                                @endif
                                <li><a class="dropdown-item" href="{{ route('car_manufacturers.index') }}">All Manufacturers</a></li>
                            </ul>
                        </li>
    ...
    @section('content')
                    ...
                    <div class="row">
                        @foreach($cars as $car)
                            <div class="new_car_car col-md-4">
                                <a href="{{ route('car.show', $car->id) }}" class="plain-link">
                                    <div class="car_card">
        ...
        @isset($newes)
            <section class="new_car mt-5">
                ...
                <div class="container mt-3">
                    <div class="row">
                        @foreach($newes as $new)

                            @if(isset($new) && $new)
                                <div class="new_car_car col-md-4">
                                    <a href="{{ $new->id ? route('news.show', $new->id) : '#' }}" class="plain-link">
                                        <div class="car_card">
                                            <div class="card mb-3 news_card">
                                                @if(isset($new->user))
                                                    <strong>{{ 'By '. $new->user->name }}</strong>
                                                @endif
                                                ...
                                                @if(isset($new->tags) && count($new->tags) > 0)
                                                ...
                                                @if (isset($new->content) && strlen($new->content) > 30)
                                                    <p class="news-content">{{ substr($new->content, 0, 30) }}...</p>
                                                @else
                                                    <p class="news-content">{{ $new->content ?? 'No content available' }}</p>
                                                @endif
                                            </div>
                                        </div>
                                    </a>
