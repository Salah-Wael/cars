                ...
                <div class="mx-auto">
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle fw-semibold ms-2" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" style=""></a> <!-- Dropdown toggle -->
