                ...
                <div class="mx-auto">
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <li><a class="dropdown-item" aria-labelledby="navbarDropdown" href="{{ route('news.index') }}">All News</a></li>
                            @if (auth()->check() && auth()->user()->role == 'admin')
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        @if (auth()->check() && auth()->user()->role == 'admin')
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <li><a class="dropdown-item" href="{{ route('tag.index') }}">All Tags</a></li>
                        ...
                        @if (auth()->check() && auth()->user()->role == 'admin')
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item" href="{{ route('car_manufacturers.index') }}">cars Manufacturers</a></li>
