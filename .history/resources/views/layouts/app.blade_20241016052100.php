        ...
        @isset($cars)
            <section class="new_car mt-5">
                ...
                <div class="container mt-3">
                    <div class="row">
                        @foreach($cars as $car)
                            <div class="new_car_card col-md-4">
    <div class="news_card">
        <img src="{{ asset('assets/img/cars/' .$car->image ) }}" alt="{{ $car->car_model }}" class="news_image">
        <div class="news_details">
            ...
            <div class="news_status">{{ strtoupper($car->status) }}</div>
            @if ($car->description)
