                ...
                <div class="mx-auto">
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        ...
                        <li class="nav-item relative group">
                            <a href="{{ route('car.index') }}" class="nav-link font-semibold">Cars</a>

                            <!-- Sub-menu -->
                            <ul class="sub-menu absolute hidden group-hover:block bg-white border mt-2">
                                <li><a class="nav-link fw-semibold fs-6 ms-2 py-2 px-4 block" href="{{ route('car.create') }}">Create car</a></li>
                                <li><a class="nav-link fw-semibold fs-6 ms-2 py-2 px-4 block" href="{{ route('car.table') }}">Cars Table</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
