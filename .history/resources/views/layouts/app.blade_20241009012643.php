...
<body>
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                <div class="mx-auto">
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active fw-semibold fs-6 ms-2" aria-current="page" href="{{ route('dashboard') }}">Home</a>
                        </li>
                        <li class="nav-item">
                ...
                <ul class="navbar-nav mb-lg-0">
                    @guest
                        ...
                        @if (Route::has('login'))
                            ...
                            <li class="nav-item">
                                <a class="btn btn-outline-danger fw-semibold fs-6 ms-2" href="{{ route('login')}}">Log In</a>
                            </li>
                        @endif
    ...
    <img class="high_img" src="./assest/wallpaperflare.com_wallpaper (2).jpg" alt="">
        </div>
    </div>
    </div>
...
<section class="offer mt-3">
    <div class="offer_for_you container text-center">
        ...
        <p style="color:  #6C6C6C;">"We offer everything you need to find the perfect car, with competitive prices and exceptional services."</p>
    </div>
</section>
    ...
    <div class="row">
      <div class="car_img col-md-3">
        <div class="car_content">
          <img src="./assest/1.jpeg" alt="Trusted Quality">
