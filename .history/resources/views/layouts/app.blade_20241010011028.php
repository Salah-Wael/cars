            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                <div class="mx-auto">
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a href="{{ route('car.index') }}">Cars</a>
                            <ul class="sub-menu">
                                <li><a class="nav-link fw-semibold fs-6 ms-2" href="{{ route('car.create') }}">Create car</a></li>
                                <li><a class="nav-link fw-semibold fs-6 ms-2" href="{{ route('car.table') }}">cars Table</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
