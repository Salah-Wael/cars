...
<body>
    ...
    <!-- Dropdown Toggle -->
    <a class="nav-link dropdown-toggle fw-semibold ms-2" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"></a>

    <!-- Direct Link for Cars -->
    <a class="nav-link fw-semibold fs-6 ms-2" href="{{ route('car.index') }}">Cars</a>
