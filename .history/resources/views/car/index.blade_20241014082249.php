...
@section('content')
    ...
    <div class="card-container">
        @forelse($cars as $car)
            <div class="card">
                <div style="position: relative; width: 100%; height: 450px; background-image: url('{{ asset('assets/img/cars/' . $car->image) }}'); background-size: cover; background-position: center;">
