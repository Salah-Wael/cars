                    ...
                    <div class="row">
                        @foreach ($related as $item)
                            <div class="col-lg-4 col-md-6 text-center mb-4">
                                ...
                                <!-- Product Details -->
                                <a href="{{ route('car.show', $item->id) }}" class="plain-link">
                                    <div class="product-details p-3">
                                        {{ $item->type }} {{ $item->car_model }} (<span style="color: {{ $item->color }};">{{ $item->color }}</span>)
                                        <ki class="fas fa-shopping-cart"></ki> View Details
                                    </div>
                                </a>
                            </div>
                        @endforeach
